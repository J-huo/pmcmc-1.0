function test_HIL_2(fpga_sim, software_sim, num_simulation, strain, state_count, N, sigma_t, sigma_o, init_state_parameters, iterations, initial_theta, fix_cov_std, ad_cov_std, prior_parameters, filename_save)
...
% initial_theta = [0.5, 0.9]; % initial theta values
% fix_cov_std=[0.035 0.01];%0.05/theta_dim;
...
if (state_count == 1000 || state_count == 2000 ||state_count == 4000 ||state_count == 8000 ||state_count == 16000)
    ...
    probs = zeros(state_count,obs_dim); 
end    
