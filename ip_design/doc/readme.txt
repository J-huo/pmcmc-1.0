...
The PL template has been customized to support an algorithm with the following input and output vectors:
...
Input and output vectors has been mapped to a virtual memory at the following addresses:
...
The virtual memory is used by foo_testbench.cpp during the C/RTL simulation.
