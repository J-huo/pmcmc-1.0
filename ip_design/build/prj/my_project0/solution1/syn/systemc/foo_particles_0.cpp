...
#include "foo_particles_0.h"

using namespace std;
using namespace sc_core;
using namespace sc_dt;

void foo_particles_0::proc_mem_q()
{
...
void foo_particles_0::proc_mem_ra()
{
...
void foo_particles_0::proc_mem_ce()
{
    sc_lv<1> tmp;
    tmp[0] = ce0.read();
    mem_ce.write(tmp);
...
void foo_particles_0::proc_mem_wa()
{
...
void foo_particles_0::proc_mem_we()
{
    sc_lv<2> tmp;
    tmp[1] = we0.read();
    tmp[0] = we1.read();
...
void foo_particles_0::proc_mem_d()
{
...
void foo_particles_0::proc_addr()
{
...
// check collision
void foo_particles_0::proc_check()
{
    int f = 0;
    for (int i = 0; i < 1; i++) {
        for (int j = i + 1; j < 2; j++) {
