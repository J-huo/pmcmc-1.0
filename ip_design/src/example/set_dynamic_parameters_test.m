...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%prior_parameter_values = zeros(prior_parameters,1);
%initial_mcmc_sample = zeros(theta_dimension,1);
%proposal_std = zeros(theta_dimension,1);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if (state_sequence == 1000 || state_sequence == 2000 ||state_sequence == 4000 ||state_sequence == 8000 ||state_sequence == 16000)
    ...
    [states, data_temp]=generate_data(state_dimension,state_sequence,...
            ...
            state_prior_parameters_dim,state_prior_parameters);
