function [thetas, liks, priors, posteriors, particles, acceptance_rate, prop_thetas, prop_liks, prop_priors, prop_posteriors, urnd_matlab] = adpmcmc_new_single(theta_dim,...
    ...
    alpha_prior,beta_prior,observations,states,prior_parameters)
